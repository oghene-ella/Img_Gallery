...
const Login = () => {
	return (
		<section className="w-screen h-screen flex gap-5 font-mooli_sans">
			<section className="w-1/2 flex flex-col items-center p-5 justify-center gap-10">
				{/* header and logo */}
				<span className="w-11/12 flex flex-col gap-5">
					<img src={img_logo} className="w-1/12" />
					<span className="flex flex-col gap-2">
						<h1 className="text-5xl">Welcome Back!</h1>
						<p className="text-lg text-gray-500 w-2/3">
				...
				<form className="w-11/12 flex flex-col gap-10">
                    ...
                    {/* login button */}
					<input type="submit" value="Login" className="bg-blue-700 text-white py-3 rounded-xl hover:bg-blue-600" />
				</form>
			</section>
			<img src={login_bg} className="w-1/2 bg-cover" />
		</section>
	);
};
